...
<head>
    ...
    <title>Teachers Dashboard | HETC Feedback System</title>
...
<body>
    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="tea_dash.php"><br><h2>HETC</h2></a>
            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            <a href="update_teach.php" aria-expanded="false"><span class="educate-icon educate-professor icon-wrap"></span> <span class="mini-click-non">Update</span></a>
                        </li>
                       <li>
    ...
    <div class="all-content-wrapper">
       ...
       <div id="form">
            <form action="update_teach.php" method="post">
                <ul class="form-style-1">
                    <label align="center">
                        <h1 style="font-family: courier-new">Update your info here.</h1>
                    </label>
                    
                    <li>
                        <label>Subject Code <span class="required">*</span></label>
                        <input type="text" name="subcode" class="field-long" />
                    </li>

                    <li>
                        <label>Semester <span class="required">*</span></label>
                        <input type="text" name="sem" class="field-long" />
                    </li>
                    <li>
                        <label>Department<span class="required">*</span></label>
                        <select name="dept" class="field-select" class="required" placeholder="Department">
    ...
    <?php
        ...
        if(isset($_POST['submit']))
        {
            ...
            $teacode=$_SESSION['profcode'];
            $sem=$_POST['sem'];
            $con = mysqli_connect("localhost","root","","feedback");
            if($con)
            {
                $sql="INSERT INTO `sub` VALUES('$fname','$lname','$dept','$subcode','$teacode',$sem,'$uname',0)";
    ...
    <?php
        $uname=$_SESSION['uname'];
        $con = mysqli_connect("localhost","root","","feedback");
        $sql = "select * from `sub` where `uname`='$uname' and not `subcode`=''";
        $result=mysqli_query($con,$sql);
    ...
    <table class="minimalistBlack">
       ...
       <?php
         ...
         if(isset($_POST['del']))
        {
            ...
            $sql="DELETE FROM `sub` WHERE `dept`='$dept' and `subcode`='$subcode' and `teacode`='$teacode' and `sem`=$sem and `uname`='$uname'"; 
            $con = mysqli_connect("localhost","root","","feedback");
            $result=mysqli_query($con,$sql);
            if(!$result)
            {
