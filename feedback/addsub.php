         ...
         <div id="form">
            <form action="addsub.php" method="post">
                <ul class="form-style-1">
                    <label align="center">
                        <h1 style="font-family: courier-new">ADD Subjects here.</h1>
                    </label>
                    
                    <li>
                        <label>Subject Code <span class="required">*</span></label>
                        <input type="text" name="subcode" class="field-long" class="form-control" />
                    </li>


                    <li>
                        <label>Subject Name <span class="required">*</span></label>
                        <input type="text" name="subname" class="field-long" class="form-control" />
                    </li>
...
if(isset($_POST['submit']))
{
    ...
    {
        echo "<script>alert('Enter valid Values');</script>";
    }
    else
    {
        include('dbconnect.php');
        $con=db_connect();
        $sql="INSERT INTO `subjects` VALUES('$subcode','$subname')";
